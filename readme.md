...
<p align="center">
    <img src="imgs/api-structure.png">
</p>
<br>
...
<a href="https://documenter.getpostman.com/view/9897635/2sAXqs83S9" target="_blank">
    <img src="imgs/api-doc-button.png" width="200" height="60"/>
</a>
...
#### API Keys Collection: Example Dataset
...
```
{
    ...
    "comments" : "General",
    "status" : true,
    "createdAt" : ISODate("2024-09-20T03:45:13.682Z"),
    "updatedAt" : ISODate("2024-09-20T03:45:13.682Z")
}
```